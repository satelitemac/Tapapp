...
st.markdown("""<style>
    ...
    .expanded-right-panel { background: #000 !important; border: 2px solid #ff4b4b !important; padding: 2.5vh !important; border-radius: 12px !important; color: #ffffff !important; font-size: 2.2vh !important; line-height: 1.6 !important; height: 600px !important; overflow-y: auto !important; scrollbar-width: none; }
...
if d:
    ...
    with c3:
        ...
        # --- BLOQUE RÍGIDO DERECHO (CONTROL TOTAL) ---
        with st.container(height=650, border=False):
            ...
            # MODO MAQUETA
                ...
                if st.session_state.mostrar_letras:
                    st.markdown('<div class="bio-box">🎵 LYRICS ACTIVAS...</div>', unsafe_allow_html=True)
